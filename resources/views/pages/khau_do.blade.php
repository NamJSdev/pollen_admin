@extends('layouts.app')
@section('title', 'Danh sách cấu hình khẩu độ')
...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        <h4 class="mb-3">Danh Sách Cấu Hình Khẩu Độ</h4>
                    </div>
                    <div class="iq-search-bar device-search w-50 d-flex flex-wrap justify-content-end">
                        <form id="searchForm" action="{{route('KhauDo')}}" method="GET"
                            class="searchbox d-flex">
                            <div>
                                <a class="search-link" href="#"><i class="ri-search-line"></i></a>
                                <input type="text" id="searchInput"
                                    style="border-top-right-radius: 0%;border-bottom-right-radius: 0%;"
                                    class="text search-input" placeholder="Tìm kiếm theo tên khẩu độ..." name="search"
                                    value="" />
                            </div>
                        ...
                        <a href="" class="btn btn-primary add-list" data-toggle="modal" data-target="#createModal"><i
                                class="las la-plus"></i>Thêm Mới Khẩu Độ</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-12">
    ...
    <div id="createModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="createForm" action="{{ route('ThemKhauDo') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h4 class="modal-title">Thêm Khẩu Độ</h4>
    ...
    <div id="editModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="editForm" action="{{ route('SuaKhauDo') }}" method="POST">
                    @csrf
                    <div class="modal-header">
    ...
    <div id="deleteModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="deleteForm" action="{{ route('XoaKhauDo') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h4 class="modal-title">Xóa Khẩu Độ</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body">
                        <p>Bạn có chắc chắn muốn xóa khẩu độ này?</p>
